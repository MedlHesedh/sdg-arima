...
export default function LaborRecordForm() {
  ...
  return (
    <Card className="w-[350px] mx-auto p-6">
      <CardHeader>
        <CardTitle>Add New Labor Record</CardTitle>
        <CardDescription>Fill in the details to add a new labor record.</CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button type="submit" className="w-full">Add Labor Record</Button>
        </form>
      </CardContent>
