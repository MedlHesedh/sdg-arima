...
export default function MaterialHistoryForm() {
  ...
  return (
    <Card className="w-[350px] mx-auto p-6">
      <CardHeader>
        <CardTitle>Add New Material History</CardTitle>
        <CardDescription>Fill in the details to add a new material history.</CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button type="submit" className="w-full">Add Material History</Button>
        </form>
      </CardContent>
